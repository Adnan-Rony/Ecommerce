    ...
    <>
      ...
      <header className="bg-[#1d4c9e] text-white sticky top-0 z-50 shadow-md">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-3 flex items-center justify-between gap-4">
          ...
          <Link
            to="/"
            className="font-extrabold text-xl whitespace-nowrap tracking-tight"
          >
            Zap<span className="text-yellow-300">Zone</span>
            <span className="text-xs ml-1 bg-yellow-300 text-blue-900 px-1.5 py-0.5 rounded">
              BD
            </span>
          </Link>
        ...
        >
          ...
          <div className="bg-[#1d4c9e] text-white flex justify-between items-center px-5 py-4">
            <Link to="/" className="font-extrabold text-lg">
              ZapZone
              <span className="text-xs ml-1 bg-blue-600 text-white px-1.5 py-0.5 rounded">
                BD
              </span>
            </Link>
